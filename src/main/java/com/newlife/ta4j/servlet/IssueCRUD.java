...
public class IssueCRUD extends HttpServlet {
    ...
    private static final String LIST_ISSUES_TEMPLATE = "/templates/crud/list.vm";
    private static final String NEW_ISSUE_TEMPLATE = "/templates/crud/new.vm";
    private static final String EDIT_ISSUE_TEMPLATE = "/templates/crud/edit.vm";

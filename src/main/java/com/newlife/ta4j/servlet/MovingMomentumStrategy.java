...
public class MovingMomentumStrategy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (null != component) {
			writer.println(
					"Yes, found 'component' name. Searching for Component in " + component + " project...<br><br>");

		} else {
			component = "MWG";
			writer.println("Not set 'component' found component, Seach for default project " + component + "...<br><br>");
		}

		writer.println("Searching for issues in Component...<br><br>");

		try {
			writer.println("find stock by Tripple ATR Strategy in HSX...<br><br>");			
			// Run Vn30 Symbol in HOSE
			Collection<Strategy> strategyLst = JiraBarLoader.findStockByTrippleATRStrategy(pid, HSX.getStockList(HSX.VN50));
			...
			while(iterator.hasNext()) {
				...
				writer.println("Found strategy should run: <a href=\"/jira/plugins/servlet/chart?symbol="+strategy.getName()+"\" target=\"_blank\">"+strategy.getName()+"</a> -----> Check this <br><br>");
			}
